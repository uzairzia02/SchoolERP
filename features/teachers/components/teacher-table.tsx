...
import { teacherColumns } from "@/features/teachers/components/teacher-columns";
...
interface TeacherTableProps {
  initialData: PaginatedResponse<TeacherListItem>;
}

export function TeacherTable({ initialData }: TeacherTableProps) {
    ...
    <div className="space-y-4">
      ...
      <div className="rounded-xl border bg-card overflow-hidden">
          ...
          <table className="w-full text-sm">
            ...
            <tbody>
              {table.getRowModel().rows.length === 0 ? (
                <tr>
                  <td colSpan={teacherColumns.length} className="px-4 py-16 text-center">
        ...
        <div className="flex items-center justify-between border-t px-4 py-3">
          <p className="text-xs text-muted-foreground">
            Showing {initialData.data.length} of {initialData.total} teachers
          </p>
